...
<!-- section start -->
<!-- attr: { id:'numerals', class:'slide-section', showInPresentation:true, hasScriptWrapper:true } -->
# Numeral Systems
...
<!-- attr: { id:'binarydecimal', showInPresentation:true, hasScriptWrapper:true } -->
...
<!-- <img class="slide-image" showInPresentation="true"  src="imgs/bin-2-dec.png" style="top:30%; left:5%; width:80%; z-index:-1" /> -->
...
- Each position represents a power of 16:
  ...
  <!-- <img class="slide-image" showInPresentation="true"  src="imgs/hex-nums.png" style="top:30%; left:5%; width:95%; z-index:-1" /> -->


<!-- attr: { id:'conversions',  showInPresentation:true, hasScriptWrapper:true } -->
# Hexadecimal to Decimal Conversion
- Multiply each digit by its exponent

<!-- <img class="slide-image" showInPresentation="true"  src="imgs/hex-2-dec.png" style="top:35%; left:10%; width:75%; z-index:-1" /> -->
...
<!-- attr: { id:'representation', showInPresentation:true, hasScriptWrapper:true } -->
...
<!-- attr: { id:'textrepresentation', showInPresentation:true, hasScriptWrapper:true } -->
